...
const FLUX_FROM = "var(--flux-from, #ff1a1a)";
const FLUX_TO = "var(--flux-to, #ff8a8a)";
...
export function ProgressiveFluxLoader({
  ...
  return (
    ...
    >
      {showLabel && (
        <div
          className="relative h-12 w-full select-none sm:h-14"
      ...
      <div
        className={cn(
          "relative h-4 w-full overflow-hidden rounded-full bg-white/10 shadow-[inset_0_2px_3px_rgba(0,0,0,0.45),inset_0_-1px_2px_rgba(255,255,255,0.06)]",
          barClassName
        )}
        role="progressbar"
        aria-valuemin={0}
